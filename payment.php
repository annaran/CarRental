            ...
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading " >
                            ...
                            <div class="checkbox pull-right " >
                                <label>
                                    <input type="checkbox" name="checkbox-remember" id="checkbox-remember" checked="checked"  />
                                    Remember
                                </label>
                            </div>
                            </div>
                                    ...
                                    <div class="col-xs-7 col-md-7">
                                        ...
                                        <div class="form-group">
                                            <label for="expiryYear">
                                                EXPIRY YEAR</label>
                                            <div class="col-xs-6 col-lg-6 pl-ziro">
                                                <input type="text" class="form-control" name="expiryYear" id="expiryYear" placeholder="YY"  /></div>
                                        </div>
                                    </div>
                    ...
                    <ul class="nav nav-pills nav-stacked">
                        <li class="active"><span class="badge pull-right"><span class="glyphicon glyphicon-xxx"></span><?php echo $total; ?></span> Amount</a>
                        </li>
                    </ul>
                    <br/>
                   <!-- <a href="payment_success" class="btn btn-business btn-lg btn-block"  type="submit">Pay</a>-->
