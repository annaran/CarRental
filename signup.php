...
?>
    <div class="container">
        ...
        <form id="frmSignup" class="myForm" action="apis/api-signup" method="POST">
            ...
            <div class="col-sm-12 col-md-12 col-lg-12">
            <input name="txtSignupPassword" class="form-control" type="password" placeholder="Password" value="">
            </div>
                <div class="col-sm-12 col-md-12 col-lg-12">
            <input name="txtSignupConfirmPassword" class="form-control" type="password" placeholder="Confirm password" value="">
                </div>
<br>
            <div class="col-sm-12 col-md-12 col-lg-12">
